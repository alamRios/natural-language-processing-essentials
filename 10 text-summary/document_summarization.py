...
install gensim: conda install -c anaconda gensim 
install networkx: conda install -c conda-forge networkx 
install htmlparser: conda install -c auto htmlparser
install pattern: conda install -c asmeurer pattern / pip install pattern3
